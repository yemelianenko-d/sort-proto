...
export const UI_TEXTS = {
  ...
  tutorials: {
    ...
    chains: {
      ...
      body: 'Колонку тримають печатки-стрічки, а всередині — потрібні блоки. На кожній печатці свій блок: збери повний набір цього кольору деінде — і печатка спаде. Коли впадуть усі, колонка відкриється. Печаток буває кілька.',
    },
    multilock: {
      title: 'Два замки',
