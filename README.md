...
set-unlock колонка (відкривається після N зібраних наборів, тригер у момент
валідації сета), подвійний замок (одна колонка, N ключів; кожен ключ —
...
C колонка кольору, S set-unlock.
