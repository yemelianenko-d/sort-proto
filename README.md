...
всього. У чит-режимі (`?debug=true`) клітинки лоббі показують гліфи механік
рівня: I чорнило, K ключі (K2 — два), L замок без ключа, T скотч, C колонка
кольору, S set-unlock.
