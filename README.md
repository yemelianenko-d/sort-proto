...
Розподіли типів/capacity/механік тримаються біля цілей гайдлайна
(8 типів = 10 чистих board-load піків, C5 = 12 рівнів після 90-го).
Звіт: `npx tsx tools/build-levels.ts`; незалежний аудит: `npx tsx
tools/analyze-levels.ts`. У чит-режимі (перемикач у Налаштуваннях) клітинки лоббі показують гліфи
