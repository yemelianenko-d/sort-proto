...
**Наступний великий пункт — trap-націлений відбір:**
генератор при відборі рівня має цілити прямо в trap-density (safeRatio),
щоб найскладніші рівні мали 50–60% безпечних ходів замість поточних 70–80%.
